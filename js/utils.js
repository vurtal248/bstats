 ...
 * @param {boolean} [isPct=false] - Whether the value is a percentage.
...
/**
 * Compute derived metrics (percentages, PPG, GameScore) in-place for a given row.
 * @param {object} row - The data row representing a game or season.
 */
 ...
 * @returns {number} A normally distributed random number clamped to [-3, 3].
 */
...
/**
 * Get current theme colors based on the html data-theme attribute.
 * @returns {object} The theme color map.
 */
export function getThemeColors() {
  // Light is default (no attribute). Dark has data-theme="dark".
